...
import { EDIT_PROFILE, GET_USER_DETAILS, GET_WORKERS_LIST, OPEN_TO_WORK_OFF, OPEN_TO_WORK_ON, REGISTER_AS_WORKER } from '../controllers/events';
...
router.put('/register-as-worker', fileUploadMulterField(['profilePicture', 'identity']), eventHandler(REGISTER_AS_WORKER));
