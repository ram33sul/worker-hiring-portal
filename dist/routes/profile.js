...
router.put('/edit-user-profile', (0, multer_1.fileUploadMulter)(), (0, account_1.eventHandler)(events_1.EDIT_PROFILE));
router.put('/register-as-worker', (0, multer_1.fileUploadMulter)(), (0, account_1.eventHandler)(events_1.REGISTER_AS_WORKER));
